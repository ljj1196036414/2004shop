...
<html>
	<head>
		...
		<link rel="stylesheet" href="/personal/css/css.css" />
		<link rel="stylesheet" href="/personal/css/common.min.css" />
		<link rel="stylesheet" href="/personal/css/ms-style.min.css" />
		<link rel="stylesheet" href="/personal/css/personal_member.min.css" />
		<link rel="stylesheet" href="/personal/css/Snaddress.min.css" />
		<link rel="stylesheet" href="/personal/css/sui.css" />
		<script type="text/javascript" src="/personal/js/jquery-1.9.1.min.js" ></script>
		<script type="text/javascript" src="/personal/js/sui.js" ></script>
		<style>
		body {
		    background: #f5f5f5;
		}
...
a{
			...
			<div class="ng-toolbar-con wrapper">
				<div class="ng-toolbar-left">
					<a class="ng-bar-node ng-bar-node-backhome" id="ng-bar-node-backhome" style="display: block;">
						<span><img src="/personal/png/Home.png" style="margin-right: 10px;"/>返回买啦首页</span>
					</a>
					<div class="ng-bar-node-box ng-site-nav-box">
						<a href="" class="ng-bar-node ng-bar-node-site">
							<span><img src="/personal/png/daohang.png" style="margin-right: 5px;" />网站导航</span><em class="ng-iconfont down"></em>
						</a>
				...
				<div class="ng-toolbar-right">
					...
					<a class="ng-bar-node ng-bar-node-mini-cart" rel="nofollow" href="">
						<span><img src="/personal/png/购物车.png" />&nbsp;购物车</span>
    ...
    background: none;
					...
					<nav class="ms-nav">
						...
						<div class="ms-search">
							<form>
								...
								<img src="/personal/png/搜索.png"  style="height: 10px;width: 10px;float: right;margin-right: 10px;" />
							</form>
						</div>
					</nav>
				</div>
				...
				<div class="header-useinfo" id="">
					...
					<div class="ms-name-info">
        				...
        				<a >安全等级：<span>中</span></a>
							...
							<a class="bind-phone">
								<i style="background-image: url(/personal/png/修改手机.png);"></i>修改手机</a>
							<a class="bind-email">
								<i style="background-image: url(/personal/png/绑定邮箱.png);"></i>修改邮箱</a>
							<a class="manage-addr"><i style="background-image: url(/personal/png/地址管理.png);"></i>地址管理</a>
						</div>
					</div>
				</div>
					...
					<div class="ms-side" style="margin-top: 20px;">
						<article class="side-menu side-menu-off">
							<dl class="side-menu-tree" style="padding-left: 50px;">
								<dt><img src="/personal/png/我的购物车.png"  style="margin-right: 10px;margin-left: -20px;"/>我的购物车</dt>
								<dt><img src="/personal/png/file.png"  style="margin-right: 10px;margin-left: -20px;"/>订单管理</dt>
								<dd>
									<a href="我的订单标注.html">我的订单</a>

								</dd>
								<dd>
									<a href="店铺收藏.html">我的收藏</a>
								...
								<dt><img src="/personal/png/我的买啦.png"  style="margin-right: 10px;margin-left: -20px;"/>我的买啦</dt>
								<dd>
								...
								<dt><img src="/personal/png/v-card-3.png"  style="margin-right: 10px;margin-left: -20px;"/>售后服务</dt>
								<dd>
									<a href="退换货.html">退换货</a>

								</dd>
								<dd>
									<a href="意见投诉.html">意见/投诉</a>
							...
							<div class="server-tab" style="margin-top: 26px;">
								...
								<div style="float: left;width:200px ;height: 152px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<span style="font-size: 36px;color: #F88600;display: block;    display: block; width: 100px; margin-left: 50px;margin-top: 28;">12</span>
									     <input  type="button" value="签到领买豆" class="signin" name="signin" style="background-color: #f56a48;border-radius: 5px;color: #fff; font-size:14px;border: 0px;width: 107px;height: 26px;margin-top: 30px;" />
									</div>
								</div>
								...
								<div style="float: left;width:200px ;height: 152px;;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<img src="/personal/png/矢量智能对象.png" style="position: absolute; margin-top: 30px;  margin-left: -80px;;" />	
									</div>
								</div>
								...
								<div style="float: left;width:200px ;height: 152px;margin-left: 20px;border: 1px #ccc solid;box-shadow: 1px 1px 1px #F5F5F5;padding: 5px;">
									<div style="width: 100%;height: 100%;border: 1px #F2873B dashed;">
										...
										<span style="width: 87px;height: 20px;background-color: #fee3dc;padding: 5px;border: 1px #C62B26 dashed;border-radius: 5px;">显示今日收益</span>
									    <img src="/personal/png/猪的图标.png" style="position: absolute; margin-top: 13px;  margin-left: -80px;;" />									</div>
								</div>
								...
								<div style="float: left;width:250px ;height: 152px;margin-left: 20px;">
								 ...
								 <div style="background-color: #fff;margin-top: 10px;height: 300px;padding: 10px;">
								 	...
								 	<img src="/personal/png/组-15.png"/>
								 	<img src="/personal/png/组-14.png" style="margin-top: 20px;"/>
								...
								<div style="background-color: #fff;margin-top: 10px;height: 200px;padding: 10px;">
								 	...
								 	<img src="/personal/png/形状-1.png" style="margin-top: 20px;"/>
								...
								<div style="background-color: #fff;margin-top: 10px;height: 300px;padding: 10px;">
								 	...
								 	<img src="/personal/png/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;"/>	
								 	<br />
								 	...
								 	<p style="width: 100px;font-size: 12px;color: #686868">化妆水化妆水化妆水化妆水化妆水化妆水</p>
								 	 ...
								 	 <div style="float:left ;">
								 	 	 <img src="/personal/png/屏幕快照-2016-04-08-15.50.46.png" style="margin-top: 10px;height: 100px;width: 100px;float: left;margin-left: 20px;"/>
								 	 	<br />
								...
								<div style="background-color: #fff;margin-top: 10px;height: 200px;padding: 10px;">
								 	...
								 	<img src="/personal/png/矢量智能对象.png" style="margin-top: 20px;"/>
								...
								<div style="width: 680px;padding:10px;display: inline-block; float: left;margin-top: 20px;background-color: #fff;">
									...
									<p style="text-align: center;margin-top: 30px;">展开全部信息</p>
									 <!--<div style="float:left;display: inline;border: 1px #ccc solid;display: inline-block;background-color: #f5f5f5;height: 25px;width: 150px;"> 
									    ...
									    <img src="/personal/png/搜索.png"  style="height: 10px;width: 10px;  margin-left: 2px; margin-bottom: 5px;" />
                                        </div> -->
								</div>
								...
								<div style="width: 680px;padding:10px;display: inline-block; margin-top:0px;background-color: #fff;float: left;">
									<div style="padding:10px ;text-align: center;float: left;">
										<div style="float: left;margin-left: 30px">
											<img src="/personal/png/wdxx_01.png" />
		...
		<script type="text/javascript " src="/personal/js/safe/ms_common.min.js "></script>
	</body>
	<script src="/jquery.jc"></script>
	<script>
		$(document).ready(function(){
			$(document).on('click','.signin',function(){
				$.ajax({
					url:"{{url('goods/personalindex')}}",
					type:"get",
					dataType:"json",
